export const projectsData = [
  {
    ...
    badge: "New Launch",
    category: "Apartment",
    overview: "Experience unparalleled urban living in our state-of-the-art luxury apartments. Designed for modern professionals, these homes offer a perfect blend of comfort, style, and connectivity, right in the heart of the city's IT hub.",
    amenities: ["Rooftop Pool", "Fully Equipped Gym", "Children's Play Area", "24/7 Security", "Indoor Games Room", "Jogging Track"],
    locationHighlights: ["2 mins from Metro Station", "Walkable to International Schools", "Surrounded by IT Parks", "Prime Shopping Malls Nearby"],
    gallery: [
  ...
  },
  {
    ...
    badge: "Hot Deal",
    category: "Villa",
    overview: "Escape to a world of tranquility and exclusivity in our premium villas. These sprawling residences offer private gardens, personal pools, and expansive living spaces, providing a sanctuary of peace away from the bustling city.",
    amenities: ["Private Pool", "Personal Garden", "Smart Home Automation", "Vastu Compliant", "Basement Parking", "Power Backup"],
    locationHighlights: ["Gated Community", "Nearby International Airport", "Proximity to ORR", "Exclusive Neighbourhood"],
    gallery: [
